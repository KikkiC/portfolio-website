    ...
    <div className="blog__container grid">
        <div className="blog__card">
            <div className="blog__thumb">
                <a href="https://kikki-digital-artwork.carrd.co/" target="_blank"><img src={Image1} alt="" className="blog__img" id="digital" /></a>
            </div>
        ...
        <div className="blog__card">
            <div className="blog__thumb">
                <a href="https://kikki-creative-writing.carrd.co/" target="_blank"><img src={Image2} alt="" className="blog__img" id="comics" /></a>
            </div>
        ...
        <div className="blog__card">
            <div className="blog__thumb">
                <a href="https://kikki-fan-art.carrd.co/" target="_blank"><img src={Image3} alt="" className="blog__img" id="fanart" /></a>
            </div>
